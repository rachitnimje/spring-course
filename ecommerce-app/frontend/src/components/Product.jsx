        ...
        <div className="right-column" style={{ width: "50%" }}>
          <div className="product-description">
            ...
            <p className="release-date" style={{ marginBottom: "2rem" }}>
              ...
              <h6>Listed : <span> <i> {new Date(product.created).toLocaleDateString("en-GB", {
                                          day: "2-digit",
                                          month: "2-digit",
                                          year: "numeric",
              })}</i></span></h6>
              {/* <h6>Listed: <span><i>{product.created ? new Date(product.created).toLocaleDateString() : "Date not available"}</i></span> </h6> */}

              {/* <i> {new Date(product.created).toLocaleDateString()}</i> */}
            </p>
            </div>
